...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1142)), "/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/[regular]/page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9499)), "/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/not-found.tsx"],
    ...
    const pages = ["/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/[regular]/page.tsx"];
    ...
    const originalPathname = "/[regular]/page"
...
/* harmony import */ var _components_MDXContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1952);
/* harmony import */ var _lib_contentParser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1558);
/* harmony import */ var _partials_PageHeader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5436);
/* harmony import */ var _partials_SeoMeta__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8610);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(117);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_navigation__WEBPACK_IMPORTED_MODULE_5__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_MDXContent__WEBPACK_IMPORTED_MODULE_1__]);
_components_MDXContent__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const generateStaticParams = ()=>{
    const getRegularPages = (0,_lib_contentParser__WEBPACK_IMPORTED_MODULE_2__/* .getSinglePage */ .i)("pages");
    const filterRegularPages = getRegularPages.filter((page)=>!page.frontmatter.layout);
    const regularPages = filterRegularPages.map((page)=>({
            regular: page.slug
        }));
    return regularPages;
};
// for all regular pages
const RegularPages = ({ params  })=>{
    const regularData = (0,_lib_contentParser__WEBPACK_IMPORTED_MODULE_2__/* .getSinglePage */ .i)("pages");
    regularData[0].notFound && (0,next_navigation__WEBPACK_IMPORTED_MODULE_5__.notFound)();
    const data = regularData.filter((page)=>page.slug === params.regular)[0];
    !data && (0,next_navigation__WEBPACK_IMPORTED_MODULE_5__.notFound)();
    const { frontmatter , content  } = data;
    const { title , meta_title , description , image  } = frontmatter;
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_partials_SeoMeta__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP, {
                title: title,
                meta_title: meta_title,
                description: description,
                image: image
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_partials_PageHeader__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                title: title
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("section", {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    ...
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: "content",
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_MDXContent__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
                            content: content
                        })
                    })
                })
...
var __webpack_exports__ = __webpack_require__.X(0, [799,872,117,907,558,440], () => (__webpack_exec__(7010)));
