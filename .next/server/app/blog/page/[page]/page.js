...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2297)), "/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/blog/page/[page]/page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9499)), "/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/not-found.tsx"],
    ...
    const pages = ["/Users/jinsup/Desktop/promptbank/nextplate-main/src/app/blog/page/[page]/page.tsx"];
    ...
    const originalPathname = "/blog/page/[page]/page"
...
/* harmony import */ var _components_Pagination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3827);
/* harmony import */ var _config_config_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3613);
/* harmony import */ var _lib_contentParser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1558);
/* harmony import */ var _lib_taxonomyParser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1423);
/* harmony import */ var _lib_utils_sortFunctions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1695);
/* harmony import */ var _partials_PageHeader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5436);
/* harmony import */ var _partials_PostSidebar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4975);
...
const { blog_folder , pagination  } = _config_config_json__WEBPACK_IMPORTED_MODULE_3__/* .settings */ .Xd;
const generateStaticParams = ()=>{
    const allPost = (0,_lib_contentParser__WEBPACK_IMPORTED_MODULE_4__/* .getSinglePage */ .i)(blog_folder);
...
const Posts = ({ params  })=>{
    const postIndex = (0,_lib_contentParser__WEBPACK_IMPORTED_MODULE_4__/* .getListPage */ .d)(`${blog_folder}/_index.md`);
    const { title , meta_title , description , image  } = postIndex.frontmatter;
    const posts = (0,_lib_contentParser__WEBPACK_IMPORTED_MODULE_4__/* .getSinglePage */ .i)(blog_folder);
    const allCategories = (0,_lib_taxonomyParser__WEBPACK_IMPORTED_MODULE_5__/* .getAllTaxonomy */ .h)(blog_folder, "categories");
    const categories = (0,_lib_taxonomyParser__WEBPACK_IMPORTED_MODULE_5__/* .getTaxonomy */ .p)(blog_folder, "categories");
    const tags = (0,_lib_taxonomyParser__WEBPACK_IMPORTED_MODULE_5__/* .getTaxonomy */ .p)(blog_folder, "tags");
    const sortedPosts = (0,_lib_utils_sortFunctions__WEBPACK_IMPORTED_MODULE_10__/* .sortByDate */ .d)(posts);
    const totalPages = Math.ceil(posts.length / pagination);
    const currentPage = params.page && !isNaN(Number(params.page)) ? Number(params.page) : 1;
    const indexOfLastPost = currentPage * pagination;
    const indexOfFirstPost = indexOfLastPost - pagination;
    const currentPosts = sortedPosts.slice(indexOfFirstPost, indexOfLastPost);
    !spreadPages(totalPages).includes(Number(params.page)) && (0,next_navigation__WEBPACK_IMPORTED_MODULE_9__.notFound)();
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_partials_PageHeader__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        className: "row",
                                        children: currentPosts.map((post, index)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                className: "mb-14 md:col-6",
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_partials_PostSidebar__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
...
var __webpack_exports__ = __webpack_require__.X(0, [799,872,795,997,114,117,222,558,95,221,423,648,220], () => (__webpack_exec__(4275)));
